...
By default the template creates a single `HelloWorld` contract under hackspiration_algorand folder in the `smart_contracts` directory. To add a new contract:
